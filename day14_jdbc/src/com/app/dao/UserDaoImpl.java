...
public class UserDaoImpl implements UserDao {
	...
	public UserDaoImpl() throws SQLException {
		...
		pst5 = cn.prepareStatement("delete from users where email=? and password=?");
	}
	...
	@Override
	public String deleteVoter(String email, String password) throws SQLException {
